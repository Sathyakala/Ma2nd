...
<div class="wraper"><!--Wraper Start Here -->
    ...
    $(window).load(function() {
		...
		<?php 
			$id = $_GET['id'];
			$sel = $db->getRow("select * from news where n_status='1' and n_id='$id'");
		?>	
			
			
			
		<div class="aboutuspage">
				<h5><?php echo ucwords($sel['n_title']);?></h5>
				<p style="color:#339933; font-weight:bold;"><?php echo $sel['n_date'];?></p>				
				<p><?php echo $sel['n_description'];?></p>
		</div>
