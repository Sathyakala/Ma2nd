...
$value=$db->getRow('select * from '.USER.' where id='.$_GET['id']);
?>
                        ...
                        <legend>Enter User Details</legend>
							<Table border="0" width="100%">
								<tr>
									<td>First Name</td>
									<td width="10">:</td>
									<td><input type="text" name="fname" style="width:195px;" value="<?php echo $value['first_name'];?>" /></td>
								</tr>
								<tr>
									<td>Last Name</td>
									<td width="10">:</td>
									<td><input type="text" name="lname" style="width:195px;" value="<?php echo $value['last_name'];?>" /></td>
								</tr>								
								<tr>
									<td>Phone</td>
									<td width="10">:</td>
									<td><input type="text" name="phone" style="width:195px;" value="<?php echo $value['phone'];?>" /></td>
								</tr>
								<tr>
									<td>Mobile Number</td>
									<td width="10">:</td>
									<td><input type="text" name="mobile" style="width:195px;" value="<?php echo $value['mobile'];?>" /></td>
								</tr>								
								<tr>
									<td>Email</td>
									<td width="10">:</td>
									<td><input type="text" name="email" style="width:195px;" value="<?php echo $value['email'];?>" /></td>
								</tr>								
								<tr>
									<td>Address 1</td>
									<td width="10">:</td>
									<td><textarea name="address" cols="22" rows="4"><?php echo $value['address'];?></textarea></td>
								</tr>
								<tr>
									<td>Address 2</td>
									<td width="10">:</td>
									<td><textarea name="address1" cols="22" rows="4"><?php echo $value['address1'];?></textarea></td>
								</tr>		
								<tr>
