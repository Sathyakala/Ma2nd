...
if ($_POST["keyword"] == "del"){
    ...
    if(mysql_num_rows($select) > 0)
	{
     $delete=$db->query("Delete from ".FILES." where gallery_id=$id");
		if($delete==TRUE)
		{
		$_SESSION['suss'] ="Image Delete successfully";
		}else{
      ...
      <tr>
		...
		<input type="hidden" name="del_id"  />   
					...
					?>
						...
						<div class="tc box padded" align="left">
							<a href="../homegallery/home/<?php echo $seli['images']; ?>" title="<?php echo $val['images']; ?>" rel="lightbox[roadtrip]" >
								<img class="small" src="../homegallery/home/<?php echo $seli['images']; ?>" alt="" width="150" height="150"/>
							</a>
						</div>
						</td>
						<td style="vertical-align:top;">
