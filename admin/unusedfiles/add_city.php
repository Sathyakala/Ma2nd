...
if($_POST['submit']=="Add"){
      $duplicate_user = $db->getOne('SELECT count(*) FROM '.CITY.' WHERE citys= ?', array(mysql_real_escape_string($_POST['name'])));
	 if ( $duplicate_user > 0 ){
			 $_SESSION['warning']="City name already exist";
		}else{
       $users_values = array(
					'citys'	=> $_POST['name'],
					'status'	=> "1");
					$db->insert(CITY, $users_values);
				$_SESSION['suss']="City add successfully";	
      }
}
?>
    ...
    <td align="center" valign="top" class="bg"><table width="970" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<div id="box" class="test">
                	<h3 id="adduser"><a href="user_list.php" style="color:#FFFFFF; text-decoration:underline;">City Add</a> >> Add City</h3>
                    <form name="userdetails" id="form" action="" method="post"  enctype="multipart/form-data">
                      <fieldset id="personal">
                        <legend>Enter City Details</legend>
